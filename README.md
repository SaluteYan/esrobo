...
当前现场 USB 拓扑使用 `3-*` 地址。`start_can.sh` 会按 USB `bus-info` 把 CAN 口重命名并设置波特率。

当前映射：

| 设备名 | USB 地址 | 波特率 | 用途 |
| --- | --- | --- | --- |
| `can_waist` | `3-7:1.0` | 1000000 | 腰部关节 |
| `can_car` | `3-8:1.0` | 500000 | Ranger 底盘 |
| `can_piper1` | `3-5.3:1.0` | 1000000 | 左 NERO 机械臂 |
| `can_piper2` | `3-5.4:1.0` | 1000000 | 右 NERO 机械臂 |
| `can_hand1` | `3-5.1.2:1.0` | 1000000 | 灵巧手 1 |
| `can_hand2` | `3-5.1.1:1.0` | 1000000 | 灵巧手 2 |
...
| 别名 | 当前物理口 | 用途 |
| --- | --- | --- |
| `/dev/rs422_ft1` | `/dev/ttyUSB0` 对应 `3-5.1.3:1.0` | 左力传感器 |
| `/dev/rs422_ft2` | `/dev/ttyUSB1` 对应 `3-5.1.4:1.0` | 右力传感器 |
| `/dev/rs485_servo` | `/dev/ttyACM0` 对应 `3-5.2:1.0` | 头部舵机 |
