...
def generate_launch_description():
    ...
    def get_spawner_node(ns, controller_name):
        return Node(
            ...
            arguments=[
                controller_name, 
                "--controller-manager", f"/left/controller_manager"
            ],
            output="screen",
        )
    ...
    left_driver = GroupAction(
        actions=[
            ...
            IncludeLaunchDescription(
                ...
                PythonLaunchDescriptionSource([ThisLaunchFileDir(), "/left_ur_control.launch.py"]),
                launch_arguments={
                    "ur_type":               "ur7e",
                    "robot_ip":              LaunchConfiguration("left_ip"),
                    "tf_prefix":             LaunchConfiguration("left_tf_prefix"),
                    "use_fake_hardware":     LaunchConfiguration("use_fake_hardware"),
                    "launch_rviz":           "false",
                    "controllers_file": "/home/esrobo/Projects/esrobo/src/dual_ur_robot/config/left_ur_controllers.yaml",
            ...
            #get_spawner_node("left", "joint_state_broadcaster"),
